...
const ServiceAreas = () => (
  ...
  >
    ...
    >
      Fencing across the Minneapolis–St. Paul metro
    </h2>
    <p className="text-base md:text-[18px] leading-[1.55] md:leading-[1.6] text-[hsl(var(--muted-foreground))] mt-3 md:mt-4 md:max-w-[70ch]">
      Glacial till, freeze-thaw, and mature tree roots all decide how a fence
      has to be built here. We set posts below the frost depth and use hot-dip
      hardware rated for cold, wet soil.
    </p>
