...
import { IMAGES, PHONE, PHONE_HREF, SMS_HREF, ROUTES, PREP_STEPS, PREP_FAQ } from "@/lib/content";
  ...
  <PageLayout>
    <section className="bg-[hsl(150_18%_18%)]">
      <div className="max-w-[1080px] mx-auto px-5 md:px-7 pt-8 md:pt-14 pb-[60px]">
        <span
          className="inline-block bg-[var(--accent)] text-white px-3.5 py-2 text-[15px] font-bold uppercase tracking-[0.16em]"
        ...
        <p className="text-[20px] leading-[1.55] text-[#d3ded8] mt-[18px] max-w-[60ch]">
          Two minutes of reading covers the whole thing: how the quote works, what happens on the
          day, and how we keep your roof, fence, and lawn out of it. Nothing is booked until you
          confirm a time with us.
        </p>
    ...
    <section className="bg-white border-b border-border">
      <div className="max-w-[1080px] mx-auto px-5 md:px-7 py-9 grid grid-cols-1 md:grid-cols-2 gap-9 items-start">
        ...
        <div>
          <div
            className="text-[15px] uppercase tracking-[0.18em] text-[var(--accent)]"
            style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          >
            The quote
          </div>
          ...
          <p className="text-[18px] leading-[1.6] text-[#454f4a] mt-3 max-w-[70ch]">
            Text us a photo of the whole tree with the house in frame and we can usually give you a
            ballpark the same day. For large removals, anything near power lines, or when you want
            it exact, an arborist comes out, walks the tree with you, and leaves a written itemized
          ...
          <div className="flex gap-2.5 flex-wrap mt-[18px]">
            {[
              ...
              <span
                key={item}
                className="border border-[#d8d3c8] px-3.5 py-2 text-base uppercase tracking-[0.06em] text-[var(--primary)]"
                style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
              >
                {item}
              </span>
    ...
    <section className="max-w-[1080px] mx-auto px-5 md:px-7 pt-16 cv-auto">
      <h2
      ...
      <p className="text-[18px] text-[#5d6862] mt-2">Four steps, no surprises.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-7">
        {PREP_STEPS.map((step) => (
          <div key={step.title} className="bg-white border border-border p-6 md:p-7">
            <div
              className="text-[15px] uppercase tracking-[0.18em] text-[var(--accent)]"
              style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
            >
            ...
            <p className="text-[17px] leading-[1.55] text-[#5d6862]">{step.body}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="max-w-[1080px] mx-auto px-5 md:px-7 py-16">
      <div className="bg-[var(--primary)] text-white p-7 md:p-11 flex flex-col md:flex-row md:items-center md:justify-between gap-8 flex-wrap">
        ...
        <div className="flex flex-col gap-3">
          <Link
            to={ROUTES.contact}
            className="bg-white text-[var(--primary)] text-xl font-bold uppercase tracking-[0.06em] px-7 py-4 text-center"
            style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          >
            Get my free quote
          </Link>
