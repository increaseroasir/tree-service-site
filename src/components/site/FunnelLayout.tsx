  ...
  <div className="min-h-screen bg-background flex flex-col">
    ...
    <header className="bg-white border-b border-border">
      <div className="max-w-[1120px] mx-auto px-4 md:px-7 py-3 flex items-center justify-between">
        ...
        <a
          href={PHONE_HREF}
          className="bg-[hsl(var(--accent))] text-white text-[17px] font-bold uppercase tracking-[0.06em] px-4 py-2.5 whitespace-nowrap"
    ...
    <footer className="bg-[hsl(var(--forest-dark))] text-[#6f7c75] text-xs">
      <div className="max-w-[1120px] mx-auto px-5 md:px-7 py-5 flex flex-col md:flex-row md:justify-between gap-2">
        <span>
          ©2026 {COMPANY.name} — Demo site. Pricing shown is illustrative only
          and not a quote.
        </span>
        <span className="flex gap-4">
          <a href={ROUTES.privacy} className="underline">Privacy</a>
          <a href={ROUTES.terms} className="underline">Terms</a>
        </span>
      </div>
    </footer>
  </div>
