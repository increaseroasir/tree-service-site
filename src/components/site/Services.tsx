      ...
      {SERVICES.map((s) => (
        ...
        >
          ...
          <div className="px-3 md:px-[18px] py-[11px] md:py-4">
            <div
              className="text-[18px] md:text-[22px] leading-[1.05] font-semibold uppercase tracking-[0.04em] md:tracking-[0.05em] text-[hsl(var(--foreground))]"
              style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
            >
              {s.name}
            </div>
            <div className="text-[13px] md:text-[15px] text-[hsl(var(--muted-foreground))] mt-1 leading-[1.35]">
              {s.tagline}
            </div>
          </div>
        </Link>
