...
const Guarantee = () => (
  <section className="max-w-[1240px] mx-auto px-5 md:px-7 py-[34px] md:py-[70px] cv-auto">
    <div className="bg-[var(--primary)] text-white md:grid md:grid-cols-2">
      {/* Mobile: image on top */}
      ...
      <div className="px-[22px] md:px-[56px] md:py-[60px] pt-[26px] pb-[30px] md:pt-[60px]">
        <div
          className="text-sm md:text-base font-bold uppercase tracking-[0.18em] text-[var(--cream)]"
        ...
        <h2
          ...
          style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
        >
          The price you approve is the price you pay. Nothing lands on your roof.
        </h2>
        <p className="text-[17px] md:text-[19px] leading-[1.5] md:leading-[1.55] text-[#d3ded8] mt-[14px] md:mt-5">
          The cheap tree guy drops limbs and hopes. We rig and lower every piece near a structure,
          carry insurance that covers your property, and put removal, stump, and haul-away on
          separate lines so you choose what you pay for. If we find something unexpected inside the
          trunk, you hear about it before we keep cutting.
        </p>
