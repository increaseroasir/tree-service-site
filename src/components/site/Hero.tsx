...
import { IMAGES, PHONE, PHONE_HREF, SMS_HREF, ROUTES, TRUST_POINTS } from "@/lib/content";
  ...
  <section className="bg-[var(--primary)]">
    ...
    <div className="md:hidden">
      ...
      <div className="px-5 pt-6 pb-8">
        <span
          className="inline-block bg-[var(--accent)] text-white px-3 py-[7px] text-sm font-bold uppercase tracking-[0.16em]"
          style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
        >
        ...
        <p className="text-[18px] leading-[1.45] text-[#d3ded8] mt-[14px]">
          Free written quote, usually within 24 hours. Insured crews across the Minneapolis–St. Paul
          metro. Cleanup included.
        </p>
        <Link
          to={ROUTES.contact}
          className="block text-center bg-[var(--accent)] text-white text-xl font-bold uppercase tracking-[0.06em] py-[17px] px-5 mt-[22px] hover:bg-[#8f4e14] transition-colors"
          style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
        >
          Get my free quote
        </Link>
        ...
        <a href={SMS_HREF} className="block text-center text-[#d3ded8] underline text-base mt-4">
    ...
    <div className="hidden md:block relative">
      ...
      <div className="relative max-w-[1240px] mx-auto px-7 py-16 grid grid-cols-[1.15fr_0.85fr] gap-14 items-center min-h-[600px]">
        <div>
          <span
            className="inline-block bg-[var(--accent)] text-white px-[14px] py-2 text-base font-bold uppercase tracking-[0.16em]"
            style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          >
          ...
          <p className="text-[21px] leading-[1.5] text-[#d3ded8] mt-5 max-w-[34ch]">
            Free written quote, usually within 24 hours. Insured crews across the Minneapolis–St.
            Paul metro. Every job ends with the wood hauled and the lawn raked.
          </p>
          <div className="flex gap-[14px] mt-8 flex-wrap items-center">
            <a
              href={PHONE_HREF}
              className="bg-white text-[var(--primary)] text-xl font-bold uppercase tracking-[0.08em] px-[30px] py-[18px] hover:bg-[var(--cream)] transition-colors"
              style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
            >
              Call {PHONE}
            </a>
        ...
        <div
          id="hero-form"
          className="bg-white text-[var(--foreground)] p-7 shadow-[0_20px_60px_rgba(0,0,0,0.35)]"
        >
          <h2
