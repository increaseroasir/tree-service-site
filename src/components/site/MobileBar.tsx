...
const MobileBar = () => (
  <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-[#ddd8ce] px-3 py-[10px] flex gap-[8px] z-50 max-w-[640px] mx-auto">
    <a
      href={PHONE_HREF}
      className="flex-none w-[84px] text-center bg-[hsl(var(--primary))] text-white text-lg font-bold uppercase tracking-[0.06em] py-[14px] px-2"
    ...
    <a
      href={SMS_HREF}
      className="flex-none w-[84px] text-center border-2 border-[hsl(var(--primary))] text-[hsl(var(--primary))] text-lg font-bold uppercase tracking-[0.06em] py-[12px] px-2"
      style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
    >
      Text
    </a>
