...
// Imported by the submitLead server function only (src/lib/lead.functions.ts), so
...
const DEFAULT_TRACKING_ENDPOINT = "https://backend.leadconnectorhq.com/external-tracking/events";
