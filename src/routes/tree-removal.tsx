...
export const Route = createFileRoute("/tree-removal")({
  head: () =>
    pageHead({
      title: "Tree Removal Minneapolis–St. Paul — Roped Down, Hauled Away",
      description:
        "Tree removal by insured crews across the Twin Cities. Dead, leaning, or storm-cracked trees taken down in controlled pieces. Free itemized quotes, cleanup included.",
      path: "/tree-removal",
