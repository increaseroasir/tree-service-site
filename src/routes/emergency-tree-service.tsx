...
export const Route = createFileRoute("/emergency-tree-service")({
  head: () =>
    pageHead({
      title: "24/7 Emergency Tree Service & Storm Damage — Minneapolis–St. Paul",
      description:
        "Tree on the house? A person answers 24/7. Structure secured and tarped, photos for your insurance, removal finished in daylight. Emergency rate quoted before we roll.",
