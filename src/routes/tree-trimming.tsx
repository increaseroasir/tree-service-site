...
import { TRIMMING_TYPES, TRIMMING_INCLUDED, TRIMMING_FAQ, TRIMMING_GALLERY } from "@/lib/services";
import { pageHead } from "@/lib/seo";

export const Route = createFileRoute("/tree-trimming")({
  head: () =>
    pageHead({
      title: "Tree Trimming & Pruning Minneapolis–St. Paul",
      description:
        "Roof clearance, deadwood removal, and crown thinning by a certified arborist. Oaks pruned November–March only. Free per-tree quotes, cleanup included.",
      path: "/tree-trimming",
